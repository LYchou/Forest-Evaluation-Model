function [wage_minError,CE_employee_minError,minError_parameter] = binary_search_fixed_CE(ESO_type,fixed_CE,searchTimes,threshold,previousWage_right,step_unit,V,sigma,T,T_exercise,step,F,c,r,mu,X,N,O,additional_wealth,gamma,tax_employee,Beta,w,tax_firm,percent,type_default,method,Div)
