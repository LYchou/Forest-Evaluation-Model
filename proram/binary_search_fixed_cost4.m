function [wage_minError,ESO_minError,Salary_minError,P_check,Q_check,minError_parameter] = binary_search_fixed_cost4(ESO_type,fixed_cost,searchTimes,threshold,previousWage_right,V,sigma,T,T_exercise,step,F,c,r,mu,X,N,O,additional_wealth,gamma,tax_employee,Beta,w,tax_firm,percent,type_default,method,Div)
...
% 較大的範圍)
% 其餘 input 就是 Employee_Stock_Option4.m 的 input (除了wage、type_tax_employee之外)
