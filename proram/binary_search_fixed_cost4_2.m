function [wage_minError,ESO_minError,Salary_minError,P_check,Q_check,minError_parameter] = binary_search_fixed_cost4_2(ESO_type,fixed_cost,searchTimes,threshold,previousWage_right,V,sigma,T,T_exercise,step,F,c,r,mu,X,N,O,additional_wealth,gamma,tax_employee,Beta,w,tax_firm,percent,type_default,method,Div)
